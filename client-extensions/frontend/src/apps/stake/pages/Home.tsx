...
import { useRewards, useStakeContract } from '../hooks';
...
export const Home = () => {
	...
	const { rewardsData, poolData, canClaim, refresh: refreshRewards } = useRewards();
					...
					<div className='space-y-8 sm:space-y-12'>
						...
						<div className='space-y-4 sm:space-y-6'>
							<Input
								...
								helperText={
									balance ? `Available: ${parseFloat(balance.formatted).toFixed(4)} ETH` : undefined
								}
